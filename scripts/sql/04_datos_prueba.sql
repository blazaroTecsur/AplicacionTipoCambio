...
INSERT INTO ttc_tasa_cambio (
    ...
    ('USD', '2025-06-03', 3.698, 3.748, 'SBS', 'SISTEMA'),
    ('USD', '2025-06-04', 3.710, 3.760, 'SBS', 'SISTEMA'),
    ('USD', '2025-06-05', 3.715, 3.765, 'SBS', 'SISTEMA'),
    ('EUR', '2025-06-01', 4.020, 4.080, 'SBS', 'SISTEMA'),
